...
export const FeedbackCard: React.FC<FeedbackCardProps> = ({ feedback, onClick, onVote, hasVoted }) => {
  return (
    <div 
    ...
    >
      ...
      <div className="flex flex-col items-center gap-1 pt-1">
          <button 
            onClick={onVote}
            className={`w-10 h-12 rounded-lg flex flex-col items-center justify-center border transition-all ${hasVoted ? 'bg-blue-50 border-blue-200 text-blue-600' : 'bg-gray-50 border-gray-100 text-gray-400 hover:border-gray-300'}`}
          >
