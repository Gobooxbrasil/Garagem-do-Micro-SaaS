...
const LandingPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-apple-text selection:bg-apple-blue selection:text-white flex flex-col overflow-x-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-3 cursor-pointer group" onClick={() => navigate('/')}>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-medium text-gray-400 uppercase tracking-[0.2em] mt-1 hidden sm:block">
                                DE MICRO SAAS
                            </span>
                        </div>
                    </div>
            ...
            <main className="flex-grow">
                ...
                <section className="pt-32 sm:pt-40 pb-16 sm:pb-24 px-6 relative overflow-hidden">
                    {/* Background */}
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-[500px] sm:h-[600px] bg-gradient-to-b from-gray-50 to-transparent rounded-full blur-3xl -z-10 opacity-60 pointer-events-none"></div>
                    ...
                    <div className="max-w-5xl mx-auto text-center relative z-10">
                        ...
                        {/* Headline */}
                        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-6 sm:mb-8 leading-[1.1] bg-gradient-to-b from-black to-gray-600 bg-clip-text text-transparent animate-in fade-in slide-in-from-bottom-8 duration-1000 px-2">
                            Valide sua ideia <br className="hidden sm:block" />antes de codar
                        </h1>

                        {/* Subheadline */}
                        <p className="text-lg sm:text-xl md:text-2xl text-gray-500 font-light mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100 px-2">
                        ...
                        {/* CTAs */}
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200 px-2">
                            <button
                                onClick={handleCTA}
                    ...
                    <div className="max-w-6xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                            {[
                                ...
                                <div
                                    key={index}
                                    className="group bg-white p-6 sm:p-8 rounded-3xl shadow-soft border border-gray-100 hover:shadow-hover hover:border-gray-200 transition-all duration-300 hover:-translate-y-1 h-full flex flex-col"
                                >
                                    <div className={`w-12 h-12 sm:w-14 sm:h-14 ${feature.bg} rounded-2xl flex items-center justify-center mb-4 sm:mb-6 ${feature.color} group-hover:scale-110 transition-transform flex-shrink-0`}>
                                        <feature.icon className="w-6 h-6 sm:w-7 sm:h-7" />
                                    </div>
                                    <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-apple-text">{feature.title}</h3>
                                    <p className="text-gray-500 leading-relaxed text-sm sm:text-base flex-grow">{feature.description}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <section className="py-16 sm:py-24 px-4 sm:px-6">
                    <div className="max-w-5xl mx-auto bg-black rounded-3xl sm:rounded-[3rem] p-6 sm:p-12 md:p-20 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-8 sm:space-y-12">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-8 md:gap-12 py-6 sm:py-8">
                                {[
                            ...
                            <button
                                onClick={handleCTA}
                                className="bg-white text-black px-8 py-4 rounded-full font-bold text-base sm:text-lg hover:bg-gray-100 transition-all shadow-xl hover:scale-105 flex items-center gap-2 mx-auto w-full sm:w-auto justify-center"
                            >
                ...
                {/* Final CTA */}
                <section className="py-16 sm:py-24 px-6 border-t border-gray-200">
                    <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
                        ...
                        <button
                            onClick={handleCTA}
                            className="bg-apple-blue hover:bg-apple-blueHover text-white px-10 py-5 rounded-full font-bold text-lg sm:text-xl shadow-2xl shadow-blue-500/30 hover:shadow-blue-500/50 transition-all transform hover:scale-105 flex items-center justify-center gap-3 mx-auto w-full sm:w-auto"
                        >
            ...
            {/* Footer */}
            <footer className="bg-gray-50 border-t border-gray-200 py-8 sm:py-12 px-6 relative z-10">
