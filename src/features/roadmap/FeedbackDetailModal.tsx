...
import { X, ChevronUp, MessageSquare, Send, Loader2, Calendar, User, Trash2 } from 'lucide-react';
import { useFeedbackDetail, useFeedbackComments, useVoteFeedback, useAddFeedbackComment, useDeleteFeedback } from '../../hooks/use-feedback';
                    ...
                    <div className="flex gap-2">
                        {isAdmin && (
                            <button
                                ...
                                className="p-2 bg-white border border-red-200 rounded-full hover:bg-red-50 transition-colors disabled:opacity-50"
                                title="Excluir Sugestão (Admin)"
                            >
